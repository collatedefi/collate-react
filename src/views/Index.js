      ...
      <section className="mt-48 md:mt-40 pb-40 relative bg-blueGray-100">
        ...
        <div className="container mx-auto">
          <div className="flex flex-wrap items-center">
            <div className="w-10/12 md:w-6/12 lg:w-4/12 px-4 md:px-4 mr-auto ml-auto -mt-16">
              <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-lightBlue-500">
                ...
                <blockquote className="relative p-8 mb-4">
                  ...
                  <p className="text-md font-light mt-2 text-white">
                    Before getting into any investments it is important to understand the risks involved.
                    Decentralised finance is a relatively new field however there are great returns available 
                    as it is still outside most people asset classes.
                  </p>
                </blockquote>
              </div>
            </div>
                ...
                <div className="w-full md:w-6/12 px-4">
                  ...
                  <div className="relative flex flex-col min-w-0">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <p className="mb-4 text-blueGray-500">
                        Medium risk of default in underlying farms. This is managed via diversification.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="w-full md:w-6/12 px-4">
                  <div className="relative flex flex-col min-w-0 mt-4">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <h6 className="text-xl mb-1 font-semibold">Operation</h6>
                      <p className="mb-4 text-blueGray-500">
                        Hacking risks are mitigated via the use of multiple vaults and ring fencing of assets
                      </p>
                    </div>
                  </div>
                  <div className="relative flex flex-col min-w-0">
          ...
          <div className="flex flex-wrap items-center">
            <div className="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48">
              ...
              <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-600">
                The price of CUSD is determined as the Total Reserve Assets available divided by
            ...
            <div className="w-full md:w-5/12 ml-auto px-12 md:px-4">
              <div className="md:pr-12">
                ...
                <h3 className="text-3xl font-semibold">
                  How to buy and sell Collate?
                </h3>
                <p className="mt-4 text-lg leading-relaxed text-blueGray-500">
                  Only a small amount is provided on Pancake Swap as liquidity in order to maximise the reserves used for farming. The LP CUSD price is pegged
                  to the true price of CUSD but may deviate from time to time as a result of supply and demand.
                </p>
                <p className="mt-4 text-lg leading-relaxed text-blueGray-500">
                  For larger deposits and withdrawals, it is recommended to use the Over The Counter service:
                </p>
                <ul className="list-none mt-6">
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        <h4 className="text-blueGray-500">
                          There is a 1% fee for OTC transactions which go back to the reserves.
                        </h4>
                      </div>
                    </div>
                  </li>
                  <li className="py-2">
                    <div className="flex items-center">
                      ...
                      <div>
                        <h4 className="text-blueGray-500">
                          The price of CUSD is guaranteed regardless of the size of the withdrawal.
                        </h4>
                      </div>
                    </div>
                  </li>
                  <li className="py-2">
                    <div className="flex items-center">
                      ...
                      <div>
                        <h4 className="text-blueGray-500">
                          Withdrawals have no impact on the price of CUSD due to 100% collateralisation.
                        </h4>
                      </div>
                    </div>
                  </li>
        ...
        <div className="container mx-auto pb-32">
          <div className="flex flex-wrap justify-center">
            ...
            <div className="w-full md:w-4/12 px-4 mr-auto ml-auto mt-32 relative">
              <i className="fab fa-cogs text-blueGray-700 absolute -top-150-px -right-100 left-auto opacity-80 text-55"></i>
            </div>
          </div>
        </div>
      </section>
